...
namespace WebApplication1
{
    public partial class teacherChat : System.Web.UI.Page
    {
        ...
        protected void logout()
        {
            ...
            Application["user"] = userName.Replace(Session["teacherName"].ToString(), "");
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            Application["chats"] = Application["chats"].ToString() + "," + Session["teacherName"].ToString() + "说：" + messageTextBox.Text.Trim() + "(" + DateTime.Now.ToString() + ")";
