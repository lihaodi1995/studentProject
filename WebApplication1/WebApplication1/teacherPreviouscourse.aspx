<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="teacherPreviouscourse.aspx.cs" Inherits="WebApplication1.teacherPreviouscourse" %>
...
<div class="userinfodrop">
    ...
    <div class="centercontent">
        ...
        <div class="pageheader">
            <h1 class="pagetitle">往期课程</h1>
            <span class="pagedesc">查看往期作业信息，下载往期作业</span>
        ...
        <div id="contentwrapper" class="contentwrapper">
	      ...
	      <div>
              <form runat="server">
             <asp:GridView ID="GridView1" DataKeyNames="year" runat="server" CellPadding="4"  ForeColor="Black" GridLines="Horizontal" Width="719px" AutoGenerateColumns="False" RowStyle-HorizontalAlign="Center"
                        BackColor="White" BorderColor="#CCCCCC" BorderStyle="None" BorderWidth="1px" OnRowCommand="GridView1_RowCommand"  >
                ...
                CommandArgument='<%# Eval("year") %>' Text="下载" CommandName="download" />
                </ItemTemplate>
                    </asp:TemplateField>
                      </Columns>
                  </asp:GridView>
